...
public sealed class GraphStrategyTests : IDisposable
{
    ...
    public void MergeState_WithValidGraphs_MergesVerticesAndEdges()
    {
        ...
        var doc1 = new TestModel();
        doc1.Graph.Vertices.Add("A");
        doc1.Graph.Edges.Add(new Edge("A", "B", "connects"));

        var doc2 = new TestModel();
        doc2.Graph.Vertices.Add("B");
        doc2.Graph.Vertices.Add("C");
        doc2.Graph.Edges.Add(new Edge("B", "C", "connects"));
        ...
        // Act
        var context = new MergeStateContext(doc1, meta1, doc2, meta2, propertyInfo, "$.Graph");
        strategy.MergeState(context);

        // Assert
        doc1.Graph.Vertices.ShouldBe(new HashSet<object> { "A", "B", "C" }, ignoreOrder: true);
        doc1.Graph.Edges.ShouldBe(new HashSet<Edge> { new Edge("A", "B", "connects"), new Edge("B", "C", "connects") }, ignoreOrder: true);
    }
    ...
    public void MergeState_WithInvalidProperty_DoesNothing()
    {
        ...
        var contextNullGetter = new MergeStateContext(doc1, meta1, doc2, meta2, propertyInfoNullGetter, "$.Graph");
        strategy.MergeState(contextNullGetter);
        ...
        var contextWrongType = new MergeStateContext(doc1, meta1, doc2, meta2, propertyInfoWrongType, "$.Graph");
        strategy.MergeState(contextWrongType);
        doc1.Graph.Vertices.ShouldBe(new HashSet<object> { "A" });
    }
}