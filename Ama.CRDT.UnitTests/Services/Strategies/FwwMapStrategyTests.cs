...
[CrdtAotType(typeof(FwwMapTestModel))]
[CrdtAotType(typeof(Dictionary<string, int>))]
internal partial class FwwMapTestCrdtAotContext : CrdtAotContext
{
}
...
public sealed class FwwMapStrategyTests
{
    ...
    public FwwMapStrategyTests()
    {
        ...
        services.AddCrdt()
            .AddCrdtAotContext<FwwMapTestCrdtAotContext>()
    ...
    public void MergeState_ShouldCombineStateUsingFww()
    {
        ...
        // Act
        strategy.MergeState(new MergeStateContext(doc1.Data, doc1.Metadata, doc2.Data, doc2.Metadata, prop, "$.map"));
