...
--->
Implement the Relational Integrity Strategy.
...
--->
**Relational Integrity Strategy:** A strategy for a foreign-key-like field. An ID can only be set if the corresponding entity exists in another replicated set, preventing orphaned references.
