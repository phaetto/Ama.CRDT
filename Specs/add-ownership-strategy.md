...
--->
Implement the Ownership Strategy.
...
--->
**Ownership Strategy:** A strategy where a property or object can only be modified by its designated "owner" replica. Updates from other replicas are ignored.
