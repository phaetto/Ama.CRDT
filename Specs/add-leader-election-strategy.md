...
--->
Implement a Leader Election strategy.
...
--->
**Leader Election Strategy:** A deterministic strategy where replicas can nominate themselves, and the one with the lexicographically highest replica ID (or other deterministic tie-breaker) becomes the "leader."
