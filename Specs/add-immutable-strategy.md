...
--->
Implement the Immutable Strategy.
...
--->
**Immutable Strategy:** For a property that can only be written once. The first write wins, and all subsequent writes are ignored.
