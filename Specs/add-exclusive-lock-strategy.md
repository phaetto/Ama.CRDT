...
--->
**Exclusive Lock Strategy (Optimistic):** A strategy where a replica can claim a temporary, exclusive "lock" on an object. Conflicting edits from other replicas are rejected or deferred until the lock is released.
