...
public class StrategyGenerateBenchmarks
{
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, lwwPath, lwwProp, basePoco.LwwValue, toPocoForLww.LwwValue, basePoco, toPocoForLww, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, counterPath, counterProp, basePoco.Counter, toPocoForCounter.Counter, basePoco, toPocoForCounter, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, gCounterPath, gCounterProp, basePoco.GCounter, toPocoForGCounter.GCounter, basePoco, toPocoForGCounter, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, boundedCounterPath, boundedCounterProp, basePoco.BoundedCounter, toPocoForBoundedCounter.BoundedCounter, basePoco, toPocoForBoundedCounter, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, maxWinsPath, maxWinsProp, basePoco.MaxWins, toPocoForMaxWins.MaxWins, basePoco, toPocoForMaxWins, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, minWinsPath, minWinsProp, basePoco.MinWins, toPocoForMinWins.MinWins, basePoco, toPocoForMinWins, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, averagePath, averageProp, basePoco.Average, toPocoForAverageRegister.Average, basePoco, toPocoForAverageRegister, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, gSetPath, gSetProp, basePoco.GSet, toPocoForGSet.GSet, basePoco, toPocoForGSet, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, twoPhaseSetPath, twoPhaseSetProp, basePoco.TwoPhaseSet, toPocoForTwoPhaseSet.TwoPhaseSet, basePoco, toPocoForTwoPhaseSet, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, lwwSetPath, lwwSetProp, basePoco.LwwSet, toPocoForLwwSet.LwwSet, basePoco, toPocoForLwwSet, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, orSetPath, orSetProp, basePoco.OrSet, toPocoForOrSet.OrSet, basePoco, toPocoForOrSet, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, arrayLcsPath, arrayLcsProp, basePoco.LcsList, toPocoForArrayLcs.LcsList, basePoco, toPocoForArrayLcs, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, fixedSizeArrayPath, fixedSizeArrayProp, basePoco.FixedArray, toPocoForFixedSizeArray.FixedArray, basePoco, toPocoForFixedSizeArray, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, lseqPath, lseqProp, basePoco.LseqList, toPocoForLseq.LseqList, basePoco, toPocoForLseq, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, voteCounterPath, voteCounterProp, basePoco.Votes, toPocoForVoteCounter.Votes, basePoco, toPocoForVoteCounter, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, stateMachinePath, stateMachineProp, basePoco.State, toPocoForStateMachine.State, basePoco, toPocoForStateMachine, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, priorityQueuePath, priorityQueueProp, basePoco.PrioQueue, toPocoForPriorityQueue.PrioQueue, basePoco, toPocoForPriorityQueue, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, sortedSetPath, sortedSetProp, basePoco.SortedSet, toPocoForSortedSet.SortedSet, basePoco, toPocoForSortedSet, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, rgaPath, rgaProp, basePoco.RgaList, toPocoForRga.RgaList, basePoco, toPocoForRga, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, counterMapPath, counterMapProp, basePoco.CounterMap, toPocoForCounterMap.CounterMap, basePoco, toPocoForCounterMap, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, lwwMapPath, lwwMapProp, basePoco.LwwMap, toPocoForLwwMap.LwwMap, basePoco, toPocoForLwwMap, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, maxWinsMapPath, maxWinsMapProp, basePoco.MaxWinsMap, toPocoForMaxWinsMap.MaxWinsMap, basePoco, toPocoForMaxWinsMap, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, minWinsMapPath, minWinsMapProp, basePoco.MinWinsMap, toPocoForMinWinsMap.MinWinsMap, basePoco, toPocoForMinWinsMap, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, orMapPath, orMapProp, basePoco.OrMap, toPocoForOrMap.OrMap, basePoco, toPocoForOrMap, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, graphPath, graphProp, basePoco.Graph, toPocoForGraph.Graph, basePoco, toPocoForGraph, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, twoPhaseGraphPath, twoPhaseGraphProp, basePoco.TwoPhaseGraph, toPocoForTwoPhaseGraph.TwoPhaseGraph, basePoco, toPocoForTwoPhaseGraph, fromDoc.Metadata, timestamp);
    ...
    {
        opsBuffer.Clear();
        var ctx = new GeneratePatchContext(patcher, opsBuffer, replicatedTreePath, replicatedTreeProp, basePoco.Tree, toPocoForReplicatedTree.Tree, basePoco, toPocoForReplicatedTree, fromDoc.Metadata, timestamp);
