...
public class ApplicatorBenchmarks
{
    ...
    public SimplePoco ApplyPatchSimple()
    {
        ...
        return applicator.ApplyPatch(new CrdtDocument<SimplePoco>(CreateSimplePocoClone(), simpleMetadata), simplePocoPatch).Document.Data!;
    }

    [Benchmark]
    public ComplexPoco ApplyPatchComplex()
    {
        return applicator.ApplyPatch(new CrdtDocument<ComplexPoco>(CreateComplexPocoClone(), complexMetadata), complexPocoPatch).Document.Data!;
    }
