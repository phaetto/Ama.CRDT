...
public interface IPartitionManager<T> where T : class, new()
{
    ...
    Task<IPartition?> GetHeaderPartitionAsync(IComparable logicalKey);
    ...
    /// </returns>
    Task<CrdtDocument<T>?> GetHeaderPartitionContentAsync(IComparable logicalKey);
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains the partition information, or null if not found.</returns>
    Task<IPartition?> GetDataPartitionAsync(CompositePartitionKey key, string propertyName);
    ...
    /// </returns>
    Task<CrdtDocument<T>?> GetDataPartitionContentAsync(CompositePartitionKey key, string propertyName);
    ...
    Task<T?> GetFullObjectAsync(IComparable logicalKey);
    ...
    IAsyncEnumerable<IPartition> GetAllDataPartitionsAsync(IComparable logicalKey, string propertyName);
    ...
    Task<long> GetDataPartitionCountAsync(IComparable logicalKey, string propertyName);
    ...
    Task<IPartition?> GetDataPartitionByIndexAsync(IComparable logicalKey, long index, string propertyName);
